...
def Predict():
    ...
    return render_template('REPORT.html', output1=RESULT, output2=PROB, query1 = inputQuery1, query2 = inputQuery2, query3 = inputQuery3, query4 = inputQuery4, query5 = inputQuery5, query6 =inputQuery6, query7 = inputQuery7, query8 = inputQuery8,query9 = inputQuery9)
